...
Em suma, podemos classificar um método como sendo um uma função ligada a um objeto instância. Os métodos podem ser de classes definidas pelo próprio usuário, mas também métodos já nativos da própria linguagem.
